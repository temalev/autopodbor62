...
const highlights = [
  ...
  { title: 'VIN, история, пробег', text: 'Документы, маркировочные обозначения, реальная история авто. Юридическая чистота и достоверность пробега.' },
  { title: 'Фото- и видеоотчёт', text: 'Не менее 150 фото и видео, плюс краткое заключение эксперта: стоит покупать или нет. Решение за вами: принимаете его на основании фактов.' },
]
  ...
  <div class="proverka-page">
    <div class="proverka-page__hero">
      ...
      <div class="proverka-page__hero-content">
        ...
        <h1 class="proverka-page__title">Проверка автомобиля перед покупкой в Рязани — глубже, чем в сервисе</h1>
        <p class="proverka-page__lead">Уже нашли вариант? Полная диагностика перед покупкой: юридическая чистота, техсостояние, кузов, электрика. Отчёт с 150+ фото и видео плюс заключение эксперта — стоит ли покупать этот автомобиль.</p>
      </div>
    </div>
