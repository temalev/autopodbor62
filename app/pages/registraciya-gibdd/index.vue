...
const relatedServices = [
  ...
  {
    to: '/import',
    title: 'Импорт из Кореи, Китая и Японии',
...
const highlights = [
  {
    ...
    text: 'Записываемся заранее, приезжаем к назначенному времени. Вам не нужно разбираться в процедуре и тратить время на ожидание.',
  },
  {
    title: 'Подготовка и проверка документов',
    text: 'Перед подачей проверяем весь пакет документов: ПТС, договор купли-продажи, квитанции об оплате госпошлин. Исключаем причины для отказа ещё до визита в МРЭО.',
  },
  {
...
const steps = [
  { num: '01', title: 'Консультация и сбор документов', text: 'Уточняем ситуацию: новый или подержанный автомобиль, куплен у физлица или юрлица, есть ли ограничения. Составляем полный список необходимых документов.' },
  { num: '02', title: 'Проверка пакета документов', text: 'Проверяем ПТС, договор купли-продажи и другие бумаги до визита в ГИБДД. Своевременно выявляем и устраняем ошибки.' },
  { num: '03', title: 'Оплата госпошлин', text: 'Рассчитываем точные суммы госпошлин (СТС и номерные знаки).' },
  { num: '04', title: 'Запись и визит в МРЭО', text: 'Предварительная запись на удобный день. Приезжаем к назначенному времени, подаём заявление и проходим осмотр автомобиля с нашим сопровождением.' },
  ...
  <div class="gibdd-page">
    <div class="gibdd-page__hero">
      ...
      <div class="gibdd-page__hero-content">
        ...
        <h1 class="gibdd-page__title">Регистрация автомобиля в ГИБДД в Рязани — без очередей</h1>
        <p class="gibdd-page__lead">Поставим на учёт без лишних поездок. Берём на себя подготовку документов, запись в МРЭО, осмотр и получение номерных знаков. Входит в стоимость подбора под ключ и импорта — или как отдельная услуга.</p>
      </div>
    </div>
        ...
        <div class="gibdd-page__cta">
          ...
          <form class="gibdd-page__form" @submit.prevent="submitLead">
            <div class="gibdd-page__form-fields">
              <input type="text" class="gibdd-page__form-input" name="name" placeholder="Ваше имя" autocomplete="name" required minlength="2" />
              <input type="tel" class="gibdd-page__form-input" name="phone" placeholder="+7 (___) ___-__-__" autocomplete="tel" required pattern="\+7 \(\d{3}\) \d{3}-\d{2}-\d{2}" title="Введите телефон полностью: +7 (999) 999-99-99" @input="handlePhoneInput" @keydown="handlePhoneKeydown" />
            </div>
