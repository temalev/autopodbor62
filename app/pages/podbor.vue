...
const relatedServices = [
  {
    ...
    description: 'Уже нашли авто сами? Проверим перед сделкой и дадим заключение эксперта.',
  },
  {
    to: '/vykup',
    title: 'Выкуп и комиссионная продажа',
    description: 'Поможем продать ваше старое авто, пока подбираем новое.',
  },
  {
    to: '/registraciya-gibdd',
    title: 'Регистрация в ГИБДД',
    description: 'Поставим машину на учёт без очередей — входит в стоимость подбора под ключ.',
  },
]
...
const includes = [
  ...
  { title: 'Регистрация а/м в ГИБДД', text: 'Подготовка маркировочных обозначений и необходимых документов, при необходимости, прохождение технического осмотра с получением диагностической карты, подача и получение документов в ГИБДД от имени нового собственника, получение гос. номеров.' },
  ...
  <div class="podbor-page">
    <div class="podbor-page__hero">
      ...
      <div class="podbor-page__hero-content">
        ...
        <h1 class="podbor-page__title">Подбор автомобиля под ключ в Рязани</h1>
    ...
    <RelatedServices :items="relatedServices" subheading="Часто берут вместе с подбором" />
  </div>
</template>
