...
useHead({
  title: 'Выкуп и продажа автомобиля — Автоподбор 62',
  meta: [
    {
      name: 'description',
      content: 'Выкупим автомобиль в день обращения — деньги сразу. Или возьмём на комиссию: профессиональные фото, размещение на всех площадках, показы и сделка полностью на нас. Рязань.',
    },
  ],
})
  ...
  <div class="vykup-page">
    <div class="vykup-page__hero">
      ...
      <div class="vykup-page__hero-content">
        ...
        <h1 class="vykup-page__title">Продайте автомобиль быстро и выгодно</h1>
